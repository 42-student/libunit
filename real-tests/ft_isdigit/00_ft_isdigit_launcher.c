...
/*   Updated: 2025/09/07 12:47:05 by mmillhof         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_isdigit_tests_launcher(void)
{
	...
	load_test(testlist, "ft_isdigit: basic test", &ft_isdigit_basic_test);
	load_test(testlist, "ft_isdigit: char test", &ft_isdigit_char_test);
	load_test(testlist, "ft_isdigit: null test", &ft_isdigit_null_test);
	load_test(testlist, "ft_isdigit: space test", &ft_isdigit_space_test);
